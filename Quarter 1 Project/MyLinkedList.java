...
public class MyLinkedList<E> implements List<E> {
    ...
    private int size;
    private MyLinkedList<E> parentList;
    ...
    private MyLinkedList(MyLinkedList<E> parent, Node base, Node last, int size) {
        baseNode = base;
        lastNode = last;
        parentList = parent;
        this.size = size;
    ...
    public List<E> subList(int fromIndex, int toIndex) {
        ...
        if (toIndex == 0) {
            return new MyLinkedList<E>(this, baseNode, baseNode.prevNode, 0);
        }
        ...
        return new MyLinkedList<E>(this, base, last, toIndex - fromIndex);
    }
